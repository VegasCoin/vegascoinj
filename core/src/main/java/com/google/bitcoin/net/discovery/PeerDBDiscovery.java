 ...
 *
 * <p>It is important to use a peer db in addition to DNS seeds (via a {@link com.google.bitcoin.net.discovery.DnsDiscovery}) as it:<ul>
...
public class PeerDBDiscovery implements PeerDiscovery {
    ...
    /**
     * Creates a PeerDB for the given {@link com.google.bitcoin.core.PeerGroup}, adding this as a PeerDiscovery to the given group.
     */
    ...
    /**
     * Attaches a {@link com.google.bitcoin.core.PeerEventListener} to the given {@link com.google.bitcoin.core.PeerGroup} which listens for {@link com.google.bitcoin.core.AddressMessage}
